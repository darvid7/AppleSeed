...
public class Transaction extends DataModel {
    ...
    public Transaction(DateTime a_requestTime, String a_endpoint, ArrayList<String> a_queryParams, String a_requestBody) {
    ...
    public static void setCodeField(String codeField) {
        Transaction.codeField = codeField;
    }
    ...
    public static void setNameField(String nameField) {
        Transaction.nameField = nameField;
    }
